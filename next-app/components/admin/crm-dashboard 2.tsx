            ...
            >
              <div className="flex flex-col gap-5 xl:flex-row xl:justify-between">
                <div className="space-y-3 xl:max-w-md">
                  <div>
                    <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50">{lead.businessName}</h3>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
                    {hasEmail ? (
                      <a
                        href={makeMailtoLink(lead)}
                        onClick={() => markMessaged(lead)}
                        className="rounded-xl bg-blue-600 px-4 py-2 text-center text-sm font-medium text-white hover:bg-blue-500"
                      >
                        Email Lead
                      </a>
                    ) : (
                      <button
                        type="button"
                        onClick={() => void handleCopy(`email-${lead.id}`, templates.emailBody)}
                        className="rounded-xl border border-neutral-300 bg-white px-4 py-2 text-sm font-medium text-neutral-900 hover:bg-neutral-50 dark:border-neutral-600 dark:bg-neutral-950 dark:text-neutral-100 dark:hover:bg-neutral-800"
                      >
                        Copy Email Pitch
                      </button>
                    ...
                    {hasPhone ? (
                      <a
                        href={makeSmsLink(lead, "initial")}
                        onClick={() => markMessaged(lead)}
                        className="rounded-xl bg-green-600 px-4 py-2 text-center text-sm font-medium text-white hover:bg-green-500"
                      >
                        Text Lead
                      </a>
                    ) : (
                      <button
                        type="button"
                        onClick={() => void handleCopy(`sms-${lead.id}`, templates.smsInitial)}
                        className="rounded-xl border border-neutral-300 bg-white px-4 py-2 text-sm font-medium text-neutral-900 hover:bg-neutral-50 dark:border-neutral-600 dark:bg-neutral-950 dark:text-neutral-100 dark:hover:bg-neutral-800"
                      >
                        Copy Text Pitch
                      </button>
                    ...
                    {hasFacebook ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="rounded-xl bg-sky-600 px-4 py-2 text-center text-sm font-medium text-white hover:bg-sky-500"
                      >
                        Open Facebook
                      </a>
                    ) : (
                      <button
                        type="button"
                        disabled
                        className="rounded-xl border border-neutral-200 bg-neutral-100 px-4 py-2 text-sm font-medium text-neutral-400 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-500"
                      >
                        No Facebook
                      </button>
                    )}
                    ...
                    {hasFacebook ? (
                      <button
                        type="button"
                        onClick={() => void handleCopy(`fb-${lead.id}`, templates.facebookMessage)}
                        className="rounded-xl border border-neutral-300 bg-white px-4 py-2 text-sm font-medium text-neutral-900 hover:bg-neutral-50 dark:border-neutral-600 dark:bg-neutral-950 dark:text-neutral-100 dark:hover:bg-neutral-800"
                      >
                        Copy FB Message
                      </button>
                      ...
                      <button
                        type="button"
                        onClick={() => void handleCopy(`short-${lead.id}`, templates.smsInitial)}
                        className="rounded-xl border border-neutral-300 bg-white px-4 py-2 text-sm font-medium text-neutral-900 hover:bg-neutral-50 dark:border-neutral-600 dark:bg-neutral-950 dark:text-neutral-100 dark:hover:bg-neutral-800"
                      >
                        Copy Short Pitch
                      </button>
