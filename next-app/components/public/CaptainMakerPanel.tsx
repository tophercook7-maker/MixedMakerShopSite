...
export const CAPTAIN_MAKER_OPENING_MESSAGE =
  "Ahoy, Maker — I’m Captain Maker. Tell me what you’re trying to build, fix, promote, or grow, and I’ll point you toward the right starting place.";

export const CAPTAIN_MAKER_PAGE_PLACEHOLDER =
  "Example: I need a better website for my lawn care business but I don’t know where to start.";

type CaptainMakerPanelProps = {
...
export function CaptainMakerPanel({ variant = "embedded" }: CaptainMakerPanelProps) {
  const isPage = variant === "page";
  const inputPlaceholder = isPage
    ? CAPTAIN_MAKER_PAGE_PLACEHOLDER
    : "Ask about websites, 3D printing, property care, pricing, or your next project…";
  const submitLabel = isPage ? "Ask Captain Maker" : "Send";
  const inputLabel = isPage ? "Ask Captain Maker a question" : "Message";
  const [messages, setMessages] = useState<ChatMessage[]>([
    newMessage("assistant", CAPTAIN_MAKER_OPENING_MESSAGE, [
      { label: "Free website preview", href: "/free-mockup" },
