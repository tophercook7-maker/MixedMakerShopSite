...
const gatewayPricingTiers = [
  ...
  },
  {
    ...
    items: ["SEO improvements", "Google Business updates", "Content and page updates", "Ongoing optimization"],
  },
];
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        {/* Problem */}
        <section
          className="mx-auto mb-16 max-w-3xl rounded-[28px] border border-white/10 bg-white/5 p-6 text-left shadow-[0_12px_40px_rgba(0,0,0,0.25)] backdrop-blur-xl md:mb-20 md:p-8"
        ...
        >
          ...
          <p className="mt-5 text-base leading-relaxed text-slate-300">
            A website alone usually just sits there. If your business is not getting calls, showing up well on Google,
            or turning visitors into leads, you need more than a pretty design.
          </p>
        </section>
        ...
        >
          ...
          <p className="mt-5 text-base leading-relaxed text-slate-300">
            I build websites that are designed to look professional, explain what you do clearly, and help turn visitors
            into real customers. I also offer ongoing support for SEO, Google visibility, and updates so your site keeps
        ...
        >
          ...
          <div className="mt-8 grid gap-5 text-left md:grid-cols-3 md:gap-6">
            <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 backdrop-blur-xl md:p-6">
              ...
              <p className="mt-2 text-lg font-semibold text-white">You tell me about your business</p>
              <p className="mt-3 text-sm leading-relaxed text-slate-300">
                Share what you do, who you serve, and what you want your site to accomplish.
              </p>
            </div>
            <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 backdrop-blur-xl md:p-6">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-300/80">Step 2</p>
              <p className="mt-2 text-lg font-semibold text-white">I design your preview</p>
              <p className="mt-3 text-sm leading-relaxed text-slate-300">
                You get a custom homepage preview so you can see layout and messaging before you commit.
              </p>
            </div>
            <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 backdrop-blur-xl md:p-6">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-300/80">Step 3</p>
              <p className="mt-2 text-lg font-semibold text-white">You choose next steps</p>
              <p className="mt-3 text-sm leading-relaxed text-slate-300">
                If it&apos;s a fit, we build and launch. If not, you still leave with clarity.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-base leading-relaxed text-slate-300">
            No guesswork. Just a clear website package, a stronger growth package, and optional monthly support to keep
            things moving.
          </p>
          <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3 lg:gap-6">
            {gatewayPricingTiers.map((tier) => (
              <div
                key={tier.name}
                className={cn(
                  "rounded-[28px] border bg-white/5 p-6 shadow-[0_12px_40px_rgba(0,0,0,0.2)] backdrop-blur-xl md:p-8",
                  tier.featured ? "border-emerald-400/35 ring-1 ring-emerald-400/25 md:scale-[1.02]" : "border-white/10",
                )}
              >
                <p className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-slate-400">{tier.tag}</p>
                <h3 className="mt-3 text-lg font-semibold text-white md:text-xl">{tier.name}</h3>
                <p className="mt-2 text-2xl font-semibold text-emerald-300">
                  {tier.price}{" "}
                  <span className="text-sm font-medium text-slate-400">{tier.note}</span>
                </p>
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-sm leading-relaxed text-slate-300 md:text-base">
            Click through real layouts — demos and tools built for local service businesses.
          </p>

          <motion.div className="mt-10" whileHover={{ y: -4 }} transition={{ duration: 0.18 }}>
              ...
              <CardContent className="p-5 md:p-6">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  ...
                  <TrackedPublicLink
                    ...
                    eventName="public_web_design_sample_click"
                    eventProps={{ location: "gateway", label: "all_samples" }}
                    className="block rounded-xl bg-black/20 px-3 py-2.5 text-left text-sm text-slate-200/90 transition hover:bg-black/30"
                  >
        ...
        {/* Final CTA */}
        <section
          className="mx-auto max-w-3xl rounded-[28px] border border-emerald-400/25 bg-white/5 p-6 text-center shadow-[0_12px_40px_rgba(0,0,0,0.25)] backdrop-blur-xl md:mb-8 md:p-8"
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-slate-300 md:text-base">
            I&apos;ll put together a free preview for your business so you can see the direction before committing.
          </p>
          <Button
            asChild
