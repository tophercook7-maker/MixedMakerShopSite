...
export function BuildsPage() {
  return (
    <div className={mmsPageBg}>
      <section
        className={cn(
          "border-b bg-gradient-to-b from-[#f7f4ee] via-white/90 to-[#ece7dd]",
          mmsSectionBorder,
        )}
      >
      ...
      <section className={cn("border-b bg-white/86", mmsSectionBorder)}>
        <div className={cn(shell, mmsSectionY, "max-w-3xl")}>
          <p className="text-base leading-relaxed text-[#4a5750] md:text-lg">
          ...
          <p className="mt-6 text-sm font-medium italic text-[#5a6a62] md:text-[0.9375rem]">
            These are real builds and concepts, not overhyped products.
          </p>
        </div>
      </section>

      <section className={cn("border-b bg-[#e4e9e4]/35", mmsSectionBorder)}>
        <div className={cn(shell, mmsSectionY)}>
          <h2 className={mmsH2}>Project highlights</h2>
          <p className="mt-6 max-w-2xl text-[#4a5750] md:text-[17px]">
          ...
          <div className="mt-14 grid gap-8 md:grid-cols-2 md:gap-10">
            <div className={cn(mmsCard, "p-9 sm:p-10")}>
              ...
              <p className="mt-4 text-sm leading-relaxed text-[#4a5750] md:text-[15px]">
                Web samples, the 3D printing service path, landing pages, and lightweight tools — bundled as a simple
                starting point.
              </p>
              <Link href="/examples" className={cn(mmsTextLink, "mt-8 inline-block text-[15px]")}>
                Open examples →
              </Link>
            </div>
            <div className={cn(mmsCard, "p-9 sm:p-10")}>
              <h3 className="text-lg font-bold text-[#1e241f]">Small utilities &amp; experiments</h3>
              <p className="mt-4 text-sm leading-relaxed text-[#4a5750] md:text-[15px]">
              ...
              <div className="mt-8 flex flex-wrap gap-x-5 gap-y-2">
                <Link href="/tools" className={cn(mmsTextLink, "inline-block text-[15px]")}>
                  Tools →
                </Link>
                <Link href="/website-roast" className={cn(mmsTextLink, "inline-block text-[15px]")}>
                  Website Roast →
                </Link>
                <Link href="/free-website-check" className={cn(mmsTextLink, "inline-block text-[15px]")}>
                  Free Website Check →
                </Link>
              </div>
            </div>
