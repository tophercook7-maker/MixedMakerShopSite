...
export const PRINTING_CASE_IMAGES = {
  ...
  mount: "/images/printing/printing-case-mount.png",
} as const;

export const PRINTING_PROCESS_IMAGES = {
  intake: "/images/printing/printing-process-intake.png",
  printing: "/images/printing/printing-process-printing.png",
} as const;
