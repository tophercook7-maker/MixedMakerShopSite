...
export const leadSchema = z.object({
  ...
  source_query: z.string().max(2000).optional().transform((v) => (v === "" ? undefined : v)),
  source_platform: z.string().max(40).optional().transform((v) => (v === "" ? undefined : v)),
  capture_run_id: z.string().max(200).optional().transform((v) => (v === "" ? undefined : v)),
  capture_notes: z.string().max(4000).optional().transform((v) => (v === "" ? undefined : v)),
  crm_lane_web: z.string().max(40).optional().nullable().transform((v) => (v === "" ? undefined : v)),
