...
export const metadata: Metadata = {
  ...
  description: "Website samples, landing pages, tools, and 3D printing work — all in one place.",
};
    ...
    <div className="home-premium home-premium--textured min-h-[60vh]">
      <div className={`${shell}`}>
        ...
        <p className="mt-4 max-w-[42rem] text-[#9FB5AD] text-base md:text-lg leading-relaxed">
          Browse work by path — web design samples and tools, or 3D printing and problem-solving.
        </p>
